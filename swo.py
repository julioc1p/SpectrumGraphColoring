...
class SWOGraphColoring(SpectrumGraphColoring):
    ...
    def ThresholdSpectrumColoring(self, k):
        ...
        self._tabu_search(semi_coloring)
    ...
    def _tabu_search(self, coloring):
        max_iters = 20
        iters = 0
        # tabus = []
        ...
        while iters < max_iters:
            ...
            for v in random.sample(self.vertices(), rep):
                c = self._min_semi_interference(v, coloring, self._spectrum)
                v_color = coloring[v]
                coloring[v] = c
